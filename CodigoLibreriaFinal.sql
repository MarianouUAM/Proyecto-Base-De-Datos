...
ALTER TABLE [Tb_libros] ADD CONSTRAINT [FK_Tb_libros_Tb_autores]
	FOREIGN KEY ([Id_autor]) REFERENCES [Tb_autores] ([Id_autor]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO

ALTER TABLE [Tb_libros] ADD CONSTRAINT [FK_Tb_libros_Tb_editoriales]
	FOREIGN KEY ([Id_editorial]) REFERENCES [Tb_editoriales] ([Id_editorial]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
